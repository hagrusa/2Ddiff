...
dx = .1 #cell length in x direction, must be same as dy for now. [cm]
dy = .1 #cell length in y direction
...
source = 1e4
S[4,13] = source #10^9 neutrons /cm/s, #putting point source in middle of water
S[5,14:16] = source
S[6,16] = source
S[7,17] = source
S[8:11,18] = source
...
#make contour plot
make_plots.plot_phi_2D(phi, a, b, dx, dy, title = "Smile!!", filename = 'smile.pdf')
